...
namespace Engine
{
	...
	*/
	...
	public:
		...
		virtual uint32_t getRenderID() const = 0;		//!< gets and returns the renderer ID.
		...
		virtual void uploatMat4(const char* name, const glm::mat4& value) = 0;		//!< upload model matrices.
